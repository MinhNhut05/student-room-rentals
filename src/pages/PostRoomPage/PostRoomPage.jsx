...
import { debugFormData } from "../../utils/formDataDebug";
...
const PostRoomPage = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      // Images: each file MUST be appended individually
      if (selectedFiles.length > 0) {
        console.log(
          `Adding ${selectedFiles.length} files to FormData with key "images"`
        );
      ...
      // Debug FormData
      if (typeof window.debugFormData === "function") {
        window.debugFormData(formData);
      }

      console.log("Submitting room with FormData");
      const result = await roomService.createRoom(formData, user.token);
              ...
              <h3>
                ...
                <span className="info-tooltip">
                  ...
                  <span className="tooltip-text">
                    Những tiện nghi này sẽ giúp phòng trọ của bạn hấp dẫn hơn
                    với người thuê
                  </span>
                </span>
              </h3>
